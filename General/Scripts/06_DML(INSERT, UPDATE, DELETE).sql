...
ROLLBACK;
--> COMMIT되지않은 INSERT, UPDATE, DELETE(DML)을 취소
...
FROM
	EMPLOYEE2 
WHERE 
	EMP_NAME IN ('유재식', '방명수', '노옹철', '전형돈', '정중하', '하동운');
...
SELECT 
	E.EMP_ID, E.EMP_NAME,
	E.BONUS, L.LOCAL_NAME 
FROM EMPLOYEE2 E  
JOIN DEPARTMENT2 D ON (D.DEPT_ID = E.DEPT_CODE)
...
VALUES (999, '곽두원', '561016-1234567', 'kwack_dw@kh.or.kr',
        ...
        SYSDATE, NULL, DEFAULT); -- MO2 테이블 5행됨
